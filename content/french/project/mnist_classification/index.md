...
![Where is my image ?](projet-mnistclass-data "Aperçu du dataset")
...
Voici une vidéo présentant la technique de descente de gradient stochastique:

{{< youtube w7Ft2ymGmfc >}}

Il existe différentes méthodes pour effectuer l'actualisation des paramètres du modèle. Dans ce projet, j'ai utilisé l'actualisation classique de la descente de gradient stochastique que j'ai comparé à la méthode d'actualisation ADAM qui permet d'accélérer la descente de gradient (ADAM: A METHOD FOR STOCHASTIC OPTIMIZATION, D. Kingma & J. Ba (2015), disponible en ligne : https://arxiv.org/pdf/1412.6980.pdf). 
...
![Where is my image ?](projet-mnistclass-tab_reglog "Tableau pour la précision sur l'ensemble de validation en fonction du taux d'apprentissage et de la taille du batch")
...
![Where is my image ?](projet-mnistclass-graph_reglog "A gauche: La perte d’entropie-croisée en fonction de l’epoch. A droite : la précision en fonction de l’epoch")
...
![Where is my image ?](projet-mnistclass-perceptron "Architecture du perceptron multicouches")
...
![Where is my image ?](projet-mnistclass-pseudocode "Pseudo-code de la rétropropagation du gradient")
...
![Where is my image ?](projet-mnistclass-tab_NN "Tableau pour la précision sur l'ensemble de validation en fonction de la profondeur et largeur du réseau de neurones")
...
![Where is my image ?](projet-mnistclass-graph_NN "A gauche: La perte d’entropie-croisée en fonction de l’epoch. A droite : la précision en fonction de l’epoch")
